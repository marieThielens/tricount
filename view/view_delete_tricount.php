...
<div class="container border text-center mr-1 ml-1 mt-5 rounded">
    ...
    <hr>
    <div>
        <p class="text-danger h3">Do you really want to delete tricount <span class="font-weight-bold"><?= $tricount->title ?></span> and all of its dependencies ? </p>
    </div>
    <div>
        <p class="h2">This process cannot be undone</p>
    </div>
    <div class="mb-3">
        <a href="Tricount/edit_tricount/<?= $tricount->id ?>" type="button" class="btn btn-secondary mt-2">Cancel</a>
        <form action="Tricount/delete/<?= $tricount->id ?>" method="post">
